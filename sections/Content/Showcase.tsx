...
export default function Showcase({
  ...
  description =
    "Com apenas um clique, os anunciantes podem executar campanhas de alto desempenho em varejistas de 46 países.",
  showcase = [],
}: Props) {
  return (
    <section
      ...
      >
        <div class="flex flex-col gap-6 max-w-80 sm:max-w-fit mx-auto">
          ...
          <p
            ...
            class={clx(
              "font-normal text-body-larget text-center text-pretty block",
            ...
            >
              <div
                ...
                class={clx(
                  ...
                  "font-medium text-tag-medium text-neutral",
                  "uppercase",
                )}
              >
                {showCaseItem?.label}
        ...
        <div class="flex flex-col lg:flex-row gap-7 items-center lg:items-baseline justify-center">
          ...
          <a
            ...
            class={clx(
              // "py-4 px-6 lg:py-3",
              "lg:text-body-large",
              "uppercase  underline underline-offset-8 text-accent text-base font-medium",
              // "hover:bg-accent-content transition-colors duration-300",
            )}
